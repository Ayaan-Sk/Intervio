...
const QUESTION_BANK = {
  ...
  geography: [
    ...
    'Describe what a biome is and give an example.',
    'What is deforestation and what are its effects?',
    'What is globalization in the context of geography?',
    'What are the three largest deserts in the world?',
    'Explain the concept of a population pyramid.',
  ...
  history: [
    ...
    'Who were the ancient Egyptians and what are they known for?',
    ...
    'Who discovered America? Explain the controversy.',
